  ...
  <div class="h-auto py-6 sm:py-8 lg:py-12 mr-0 md:mr-36 ml-0 md:ml-36 flex flex-col md:flex-row">
    <div class="h-auto w-full p-2">
      ...
      <div class="md:h-36 md:w-64 h-64 w-full p-4 rounded-lg">
        <iframe src="<?= htmlspecialchars($post['GML']) ?>" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="map"></iframe>
      </div>
      ...
      <div class="overflow-y-scroll" style="height: 170vh;">
        ...
        <div class="mt-5 p-1 text-justify">
          ...
          <div class="grid grid-cols-2 gap-4 p-2 sm:grid-cols-3 sm:grid-rows-2">
            ...
            <div class="p-4 bg-gradient-to-r from-purple-200 to-pink-200 rounded-lg">
              <h4 class="text-xl font-bold text-center flex justify-center">
                LandScape Garden
              </h4>
            </div>
            <div class="p-4 bg-gradient-to-r from-purple-200 to-pink-200 rounded-lg">
      ...
      <div class="flex flex-wrap md:-m-2 -m-1">
        <div class="flex flex-wrap w-1/2">
          <div class="md:p-2 p-1 w-1/2">
            <img alt="Gate" class="w-full object-cover h-full object-center block modal-trigger" src="../Assets/Images/Amenities/1.JPEG">
          </div>
          <div class="md:p-2 p-1 w-1/2">
            <img alt="Badmintion Courtyard" class="w-full object-cover h-full object-center block modal-trigger" src="../Assets/Images/Amenities/2.JPEG">
          </div>
          <div class="md:p-2 p-1 w-full">
            <img alt="Internal Connectivity of Road" class="w-full h-full object-cover object-center block modal-trigger" src="../Assets/Images/Amenities/3.JPEG">
          </div>
        </div>
        <div class="flex flex-wrap w-1/2">
          <div class="md:p-2 p-1 w-full">
            <img alt="Garden View Seatting Area" class="w-full h-full object-cover object-center block modal-trigger" src="../Assets/Images/Amenities/7.JPEG">
          </div>
          <div class="md:p-2 p-1 w-1/2">
            <img alt="Community Area" class="w-full object-cover h-full object-center block modal-trigger" src="../Assets/Images/Amenities/5.JPEG">
          </div>
          <div class="md:p-2 p-1 w-1/2">
            <img alt="Swimming Pool & Shower" class="w-full object-cover h-full object-center block modal-trigger" src="../Assets/Images/Amenities/6.JPEG">
          </div>
        </div>
      </div>
    </div>
